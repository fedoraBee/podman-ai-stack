...
1. Navigate to the [Security Tab](https://github.com/fedoraBee/podman-ai-stack/security) of this repository.
2. Click on **Advisories** in the left sidebar.
3. Click **Report a vulnerability** to open a private draft advisory.

### Reporting Format
To help us investigate quickly, please follow the structure in our [Security Advisory Template](https://github.com/fedoraBee/podman-ai-stack/blob/main/.github/SECURITY_ADVISORY_TEMPLATE.md). Specifically, include:
